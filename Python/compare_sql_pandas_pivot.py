...
sql_conn = pyodbc.connect(
    'DRIVER={ODBC Driver 17 for SQL Server}; SERVER=LAPTOP-NLGPTOS3;DATABASE=Survey_Sample_A18;Trusted_Connection=yes')
...
p_df_answers = df_answers.pivot_table(index=['UserId', 'SurveyId'], columns='Question',
                                      values='Answer_Value').reset_index()
